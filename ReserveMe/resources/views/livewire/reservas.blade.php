<div x-cloak x-data="{ reservas: true, historial: false }" class="flex flex-col gap-5 text-white">
    <div class="flex gap-2">
        <div @click="reservas = true, historial = true"
            class="flex items-center justify-center text-base text-center rounded-lg hover:bg-emerald-600 bg-emerald-700 cursor-pointer px-2">Expandir todo
        </div>
        <div @click="reservas = false, historial = false"
            class="flex items-center justify-center text-base text-center rounded-lg hover:bg-emerald-600 bg-emerald-700 cursor-pointer px-2">Colapsar todo
        </div>
    </div>
