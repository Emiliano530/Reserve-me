<div x-cloak x-data="{ open: false }"
    :class="{ '-translate-y-full': open, '-translate-y-12': !open }"
    class="fixed overflow-hidden -bottom-40 right-4 rounded-t-3xl text-white transform transition-transform duration-500 ease-in-out z-50">
    <!--contenido cerrado-->
    <div>
