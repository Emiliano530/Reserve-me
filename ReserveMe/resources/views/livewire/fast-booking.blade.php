<div x-cloak x-data="{open: false}" class="fixed bottom-0 right-5 z-50 text-white">
    <div :class="{ 'h-[18vw]': open, 'h-[2.9vw]': !open }" class="p-2 overflow-hidden transition-all duration-1000">
        <div @click="open = !open"
        ...
        <div
            ...
            <x-button wire:click="MakeReservation" @click="open = !open" class="mt-2">Reservar</x-button>
