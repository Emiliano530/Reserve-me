<div x-cloak x-data="{ mostrar: false, reserva: false }" class="flex mt-10 flex-col items-center justify-center">
    <div class="text-white text-xl">Utiliza el filtro para buscar una mesa o selecciona un paquete para reservar.</div>
    <div class="filtro flex justify-center items-center bg-yellow-900 my-5 rounded-3xl h-20 w-[50vw]">
        <div class="flex items-center justify-center h-full w-full">
            ...
            <div class="flex justify-center items-center p-4">
                ...
                <x-input wire:keydown.enter="sendFilter" class="h-8 text-black w-36" title="Cantidad de personas" wire:model="personas" id="personas"
    ...
    <div :class="{ 'datos': mostrar, 'hidden': !mostrar }"
        ...
        <div :class="{ 'hidden': reserva, '': !reserva }" class="flex gap-5">
            <div
            ...
            @if ($evento)
                <div
                    class="flex flex-col flex-grow items-center w-96 h-96 bg-blue-600 p-2 rounded-3xl border-2 border-white">
                    <div class="p-5 text-white text-2xl font-bold">Extras</div>
                    <div class="text-white text-center">Agrega algun extra a tu reserva</div>
                    <x-input class="h-12 w-80 m-2" placeholder="Extra 1" wire:model="extra1"></x-input>
                    <x-input class="h-12 w-80 m-2" placeholder="Extra 2" wire:model="extra2"></x-input>
                    <x-input class="h-12 w-80 m-2" placeholder="Extra 3" wire:model="extra3"></x-input>

                    <p class="text-white text-sm text-center p-5">Los elementos en "extras" se considerarán, pero están
                        sujetos a disponibilidad y costos adicionales.</p>
