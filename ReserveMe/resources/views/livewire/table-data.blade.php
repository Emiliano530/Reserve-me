<div class="flex flex-col justify-center items-center">
    <div class="text-white text-xl mt-16 ">Completa tu reserva.</div>
    <div x-cloak x-data="{ zoom: false }" class="p-5 mt-10 bg-indigo-900 rounded-3xl mx-1 w-[65vw] text-white">
